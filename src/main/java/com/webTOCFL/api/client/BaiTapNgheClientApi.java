...
import com.webTOCFL.service.BaiTapNgheService;
import com.webTOCFL.service.CauHoiBaitapNgheService;
...
public class BaiTapNgheClientApi {
	...
	@GetMapping("/all")
	public ResponseEntity<Page<BaiTapNghe>> findAllByPartTOCFL(@RequestParam(defaultValue = "1") int page,
