...
//			type:'POST',
//			
//			url:"http://localhost:8080/webTOCFL/api/client/exam/ajaxTestListening/"+examId+"/"+countCorrect,
//			
//			 success: function(data){
//				 window.location.href = "http://localhost:8080/webTOCFL/reading?idExam="+examId;
//			
//				}, error : function(e) {
//					 alert("error");
//					 console.log("ERROR: ", e);
...
//	});
	...
	$('#btnSubmit').click(function(){
		...
		var url="http://localhost:8080/webTOCFL/reading/"+examId+"/"+countCorrect;
	...
	$('#btnResult').click(function(){
		...
		var url="http://localhost:8080/webTOCFL/showResultListening/"+examId+"/"+countCorrect;
		if(window.XMLHttpRequest){
			xhttp = new XMLHttpRequest();
		}
		else{
