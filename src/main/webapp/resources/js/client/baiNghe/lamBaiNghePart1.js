$(document).ready(function(){
	...
	function ajaxGetForCauHoi(page){
		...
		$.ajax({
			type: "GET",		
			url: "http://localhost:8080/webTOCFL/api/client/bai-nghe/baiNgheId="+ baiNgheId + "?page=" + page,
			success: function(result){
				...
				$.each(result.content, function(i, cauHoi){
					var divCauHoi = '<div class="postmetadata">'
						...
						+ '<img src="/webTOCFL/file/images/cauHoiBaiNgheId='+cauHoi.id+'.png" style="height: 210px; width:210px; padding-bottom: 5px;"/>'
...
//				soCau = result.totalElements;
				$.each(result.content, function(i, cauHoi){
					...
					divGiaiThich += '</li></ul></div>'
						+ '<img src="/webTOCFL/file/images/cauHoiBaiNgheId='+cauHoi.id+'.png" style="height: 100px; width:150px; padding-bottom: 5px;"/>'
                        +'<div class="form-group">'
