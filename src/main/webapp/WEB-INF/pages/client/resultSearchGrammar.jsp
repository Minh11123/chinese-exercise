	...
	<div class="span3">
		<div class="side-bar">
			...
			<ul class="nav nav-list">
				<li><a href="/webTOCFL/listening">LUYỆN BÀI NGHE</a></li>
				<li><a href="/webTOCFL/reading">LUYỆN BÀI ĐỌC</a></li>
				<li><a href="/webTOCFL/listExam">THI THỬ</a></li>
				<li><a href="/webTOCFL/listGrammar">HỌC NGỮ PHÁP</a></li>
				<li><a href="/webTOCFL/listVocab">HỌC TỪ VỰNG</a></li>
			</ul>
		...
		<c:if test="${listData.size() != 0}">
			...
			<div class="paging">
				<c:if test="${currentPage != 1}">
					<a href="/webTOCFL/listGrammar?page=${currentPage-1}">Back</a>
				</c:if>
				<c:if test="${currentPage == 1}">
					<a class="current">1</a>
				</c:if>
				...
				<c:if test="${currentPage != 1}">
					<a href="/webTOCFL/listGrammar?page=1">1</a>
				</c:if>
				...
				<c:forEach var="pag" items="${pageList}" varStatus="loop">
					...
					<c:if test="${currentPage != pag}">
						<a href="/webTOCFL/listGrammar?page=${pag}">${pag}</a>
					</c:if>
				</c:forEach>

				<c:if test="${currentPage != totalPage}">
					<a href="/webTOCFL/listGrammar?page=${currentPage+1} " class="pageNext">Next</a>
				</c:if>
			</div>
		</c:if>
	</c:if>
