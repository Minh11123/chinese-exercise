				...
				<div class="active item">
					<div class="container">
						<div class="row">
							...
							<div class="span6">
								<img
									src="${pageContext.request.contextPath}/resources/file/images/slide/aaa.png"
									alt="img not found aab" width="1000" />
							</div>
						</div>
					</div>
				</div>
		...
		<div class="row">
			...
			<div class="span4">
				...
				<p align="justify">Mỗi năm, có hàng nghìn lượt học viên đã tham
					dự các khóa học tiếng Trung  tại CFL và đạt kết quả như ý muốn. Chúng
