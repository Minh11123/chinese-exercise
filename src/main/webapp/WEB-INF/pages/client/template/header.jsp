	...
	<div id="header-row">
		<div class="container">
			<div class="row">
				<!--LOGO-->
				<div class="span3">
					<a class="brand" href="/webTOCFL"><img
						src="/webTOCFL/resources/file/images/test1.jpg" width="60"  style="background-color: rgb(102 102 102)" /></a>
				</div>
				<!-- /LOGO -->
							...
							<div class="nav-collapse collapse navbar-responsive-collapse">
								<ul class="nav">
									<c:if test="${pageContext.request.userPrincipal.name == null}">
										<li class="active"><a href="/webTOCFL">Trang chủ</a></li>
										<li class="dropdown"><a href="#" class="dropdown-toggle"
											...
											<ul class="dropdown-menu">
												...
												<li><a href="/webTOCFL/listGrammar">Ngữ pháp</a></li>
