...
<head>
<meta charset="UTF-8">
<title>WebTOCFL - Đăng nhập</title>
...
<body>
	...
	<div class="login-page">
		<div class="form">
			<h2 class="form-signin-heading" style="text-align: center">WebTOCFL -
				Đăng nhập</h2>
			<hr>
				...
				<section class="section">
					<div class="container">
						<a class="btn btn-primary" style="margin-top: 10px;"
							href="/webTOCFL/oauth2/authorization/facebook"> <i class="fa fa-facebook-square"></i> Đăng nhập với Facebook
						</a>
					</div>
				</section>
